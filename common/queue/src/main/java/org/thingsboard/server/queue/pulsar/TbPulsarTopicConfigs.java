...
public class TbPulsarTopicConfigs {
    public static final String NUM_PARTITIONS_SETTING = "partitions";

    @Value("${queue.pulsar.topic-properties.core:}")
    private String coreProperties;
    @Value("${queue.pulsar.topic-properties.rule-engine:}")
    private String ruleEngineProperties;
    @Value("${queue.pulsar.topic-properties.transport-api:}")
    private String transportApiProperties;
    @Value("${queue.pulsar.topic-properties.notifications:}")
    private String notificationsProperties;
    @Value("${queue.pulsar.topic-properties.js-executor:}")
    private String jsExecutorProperties;
    @Value("${queue.pulsar.topic-properties.ota-updates:}")
    private String fwUpdatesProperties;
    @Value("${queue.pulsar.topic-properties.version-control:}")
